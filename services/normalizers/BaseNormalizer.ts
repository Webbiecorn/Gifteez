...
import { NormalizedProduct, RawFeedItem, NormalizationResult } from '../../types/normalizedProduct';
...
export abstract class BaseNormalizer {
   ...
   */
  protected sanitizeDescription(html: string, allowHtml: boolean = false): {
    plain: string;
    html?: string;
  } {
    if (!html) {
