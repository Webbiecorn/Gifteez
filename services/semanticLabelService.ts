...
const LABEL_KEYWORDS = {
  romantic: [
    'romantic', 'romantisch', 'love', 'liefde', 'valentine', 'valentijn',
    'couple', 'koppel', 'together', 'samen', 'date', 'heart', 'hart',
    'roses', 'rozen', 'chocolade', 'chocolate', 'champagne', 'wine', 'wijn'
  ],
  sustainable: [
    'sustainable', 'duurzaam', 'eco', 'bio', 'organic', 'biologisch',
    'recycled', 'gerecycled', 'vegan', 'ethical', 'eerlijk', 'fair trade',
    'bamboo', 'bamboe', 'natural', 'natuurlijk', 'green', 'groen'
  ],
  tech: [
    'tech', 'smart', 'digital', 'digitaal', 'electronic', 'elektronisch',
    'wireless', 'draadloos', 'bluetooth', 'usb', 'gadget', 'device',
    'app', 'software', 'hardware', 'gaming', 'computer', 'laptop', 'phone'
  ],
  funny: [
    'funny', 'grappig', 'humor', 'lol', 'joke', 'grap', 'novelty',
    'quirky', 'gekke', 'bizarre', 'silly', 'sarcastic', 'sarcastisch',
    'prank', 'meme', 'comic', 'cartoon'
  ],
  minimalist: [
    'minimal', 'minimalist', 'minimalistisch', 'simple', 'simpel', 'clean',
    'basic', 'essentieel', 'essential', 'sleek', 'strak', 'modern',
    'scandinavian', 'scandinavisch', 'japanese', 'japans', 'zen'
  ],
  luxury: [
    'luxury', 'luxe', 'premium', 'exclusive', 'exclusief', 'designer',
    'high-end', 'deluxe', 'sophisticated', 'elegant', 'prestigious',
    'gold', 'goud', 'silver', 'zilver', 'leather', 'leer', 'silk', 'zijde'
  ],
  practical: [
    'practical', 'praktisch', 'useful', 'nuttig', 'functional', 'functioneel',
    'handy', 'handig', 'versatile', 'veelzijdig', 'everyday', 'dagelijks',
    'tool', 'organize', 'storage', 'opslag'
  ],
  creative: [
    'creative', 'creatief', 'art', 'kunst', 'diy', 'craft', 'handmade',
    'handgemaakt', 'artistic', 'artistiek', 'design', 'drawing', 'tekenen',
    'painting', 'schilderen', 'music', 'muziek'
  ],
  wellness: [
    'wellness', 'health', 'gezondheid', 'fitness', 'yoga', 'meditation',
    'meditatie', 'spa', 'massage', 'relaxation', 'ontspanning', 'selfcare',
    'beauty', 'skincare', 'aromatherapy', 'essential oil'
  ],
  experiential: [
    'experience', 'ervaring', 'beleving', 'activity', 'activiteit', 'adventure',
    'avontuur', 'trip', 'reis', 'workshop', 'course', 'cursus', 'lesson',
    'voucher', 'bon', 'ticket', 'event', 'evenement'
  ]
};
 ...
 */
export function calculateSemanticSimilarity(profile1: SemanticProfile, profile2: SemanticProfile): number {
  let dotProduct = 0;
  let magnitude1 = 0;
  let magnitude2 = 0;
