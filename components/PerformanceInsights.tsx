...
import { PerformanceInsightsService, ProductMetrics, TrendingProduct } from '../services/performanceInsightsService';
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">Populairste producten op basis van recent gedrag</p>
              </div>
            </div>
            <button
              onClick={loadData}
        ...
        <div className="flex gap-3">
          ...
          <div className="flex-1">
            ...
            <div className="text-sm text-gray-600 space-y-1">
              <p>• <strong>Impressies</strong>: Aantal keer dat een product is getoond</p>
              <p>• <strong>Clicks</strong>: Aantal keer dat op de affiliate link is geklikt</p>
              <p>• <strong>CTR</strong>: Click-through rate (clicks / impressies × 100%)</p>
              <p>• <strong>Score</strong>: Gewogen combinatie van impressies, clicks en CTR</p>
            </div>
          </div>
        </div>
      </div>
