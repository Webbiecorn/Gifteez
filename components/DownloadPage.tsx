        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-20">
          <div className="max-w-2xl mx-auto space-y-8">
            <div className="bg-white p-8 md:p-12 rounded-lg shadow-2xl text-center animate-fade-in">
                ...
                <h1 className="font-display text-4xl md:text-5xl font-bold text-primary mt-4">Bedankt voor je inschrijving!</h1>
                <p className="mt-4 text-lg text-gray-700">Je bent succesvol toegevoegd aan onze nieuwsbrief. Je ontvangt binnenkort de beste cadeau-ideeën in je inbox.</p>
                <p className="mt-2 text-gray-700">Klik op de knop hieronder om je gratis 'Ultieme Cadeau Planner' te downloaden.</p>
                
                <div className="mt-8">
                    <a href="/assets/Gifteez_Cadeau_Planner.pdf" download="Gifteez_Ultieme_Cadeau_Planner.pdf">
            ...
            {/* Upsell Section */}
            <div className="bg-primary text-white p-8 rounded-lg shadow-xl text-center animate-fade-in-up" style={{animationDelay: '300ms'}}>
