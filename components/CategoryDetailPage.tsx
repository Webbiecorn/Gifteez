...
const CategoryDetailPage: React.FC<CategoryDetailPageProps> = ({
  ...
  const topPartyProducts = useMemo(() => {
    ...
    const unique: { id: string; name: string; imageUrl: string; price?: number }[] = []
            ...
            <div className="flex flex-1 flex-col gap-3 p-5">
              ...
              <div className="mt-auto space-y-3">
                ...
                >
                  ...
                  <div className={`absolute -inset-2 -z-10 rounded-2xl blur-xl opacity-0 group-hover/btn:opacity-70 transition-opacity duration-500 ${
        ...
        <Container size="xl" className="py-12">
          ...
          {isSustainableCategory && subcategories.length > 1 && (
            <div className="mb-8 bg-emerald-50/50 border border-emerald-100 rounded-2xl p-6">
              <div className="mb-4">
                <h3 className="font-bold text-slate-900 text-lg mb-2">🌱 Ontdek per categorie</h3>
          ...
          {isPartyCategory && subcategories.length > 1 && (
            <div className="mb-6 bg-purple-50/50 border border-purple-100 rounded-2xl p-6">
              <div className="mb-4">
                <h3 className="font-bold text-slate-900 text-lg mb-2">🎉 Ontdek per categorie</h3>
                <p className="text-sm text-slate-600">
                  Van feestdecoratie tot drinkspellen - filter eenvoudig op jouw favoriete party categorie
                </p>
              </div>
              ...
              <div className="relative flex flex-col gap-6 p-8 md:flex-row md:items-center md:justify-between">
                <div className="space-y-4 md:max-w-lg">
                  ...
                  <p className="text-base md:text-lg text-white/90">
                    Mix ballonbogen, confettikanonnen en thema decoratie. Deze selectie wordt direct geüpdatet wanneer PartyPro nieuwe items toevoegt.
                  </p>
            ...
            <>
              <div className="mb-6 flex items-center justify-between">
                ...
                <div className="text-sm text-slate-600">
                  <span className={`font-semibold ${isSustainableCategory ? 'text-emerald-600' : 'text-rose-600'}`}>
                    {selectedSubcategory 
                  ...
                  <div className="mb-8 grid gap-6 md:grid-cols-2">
                    <div className="rounded-2xl bg-white p-6 shadow-sm border border-slate-100">
                      <div className="mb-4 flex items-center gap-2">
                        <GiftIcon className={`h-5 w-5 ${isSustainableCategory ? 'text-emerald-600' : isPartyCategory ? 'text-purple-600' : 'text-rose-600'}`} />
                    ...
                    <div className="space-y-4">
                      ...
                      <details className="group rounded-xl bg-white p-5 shadow-sm border border-slate-200 hover:border-slate-300 transition-colors">
                        ...
                        <p className="mt-3 text-sm text-slate-600 leading-relaxed">
                          Begin met het bepalen van het budget en de interesses van de ontvanger. Onze filters en categorieën helpen je snel de perfecte match te vinden. Let ook op de reviews en cadeauscore voor extra zekerheid.
                        </p>
                      </details>
                      ...
                      <details className="group rounded-xl bg-white p-5 shadow-sm border border-slate-200 hover:border-slate-300 transition-colors">
                        ...
                        <p className="mt-3 text-sm text-slate-600 leading-relaxed">
                          De verzendkosten variëren per partner en worden duidelijk getoond bij elk product. Veel partners bieden gratis verzending vanaf een bepaald bedrag. Check altijd de productpagina voor specifieke details.
                        </p>
                      </details>
                      ...
                      <details className="group rounded-xl bg-white p-5 shadow-sm border border-slate-200 hover:border-slate-300 transition-colors">
                        ...
                        <p className="mt-3 text-sm text-slate-600 leading-relaxed">
                          Ja! De meeste partners hanteren een retourbeleid van 14-30 dagen. Je koopt rechtstreeks bij onze betrouwbare partners, die elk hun eigen retourvoorwaarden hebben. Deze vind je op hun website.
                        </p>
                      </details>
                      ...
                      <details className="group rounded-xl bg-white p-5 shadow-sm border border-slate-200 hover:border-slate-300 transition-colors">
                        ...
                        <p className="mt-3 text-sm text-slate-600 leading-relaxed">
                          We selecteren alleen producten met minimaal 4.0+ sterren van geverifieerde kopers bij onze partners. Onze cadeauscore combineert reviews, populariteit en geschiktheid als cadeau voor een compleet beeld.
                        </p>
                      </details>
                      ...
                      {isSustainableCategory && (
                        <details className="group rounded-xl bg-white p-5 shadow-sm border border-slate-200 hover:border-slate-300 transition-colors">
                          ...
                          <p className="mt-3 text-sm text-slate-600 leading-relaxed">
                            Deze collectie bevat alleen producten met duurzame certificeringen (Fairtrade, B-Corp, FSC), gerecyclede materialen, of van merken die bewezen impact maken op mens en milieu. Kwaliteit én verantwoord!
                          </p>
                        </details>
                      )}
                      ...
                      {isPartyCategory && (
                        <details className="group rounded-xl bg-white p-5 shadow-sm border border-slate-200 hover:border-slate-300 transition-colors">
                          ...
                          <p className="mt-3 text-sm text-slate-600 leading-relaxed">
                            De meeste feestartikelen worden binnen 1-3 werkdagen geleverd. Voor last-minute feesten kun je vaak kiezen voor expreslevering. Check de leveringstijd bij elk product voor exacte informatie.
                          </p>
                        </details>
                      )}
                    </div>
              ...
              <div className={`mt-16 rounded-3xl p-8 md:p-12 text-center text-white shadow-2xl ${
                isSustainableCategory
