...
import { NavigateTo, ShowToast, Product } from '../types';
    ...
    <div className="bg-light-bg">
      <section className="bg-secondary py-16">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="mt-4 text-lg text-gray-700 max-w-2xl mx-auto">Vind hier onze exclusieve digitale producten om jouw cadeau-ervaring nog beter te maken.</p>
        </div>
      </section>
