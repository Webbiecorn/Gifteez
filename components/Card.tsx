...
const variantClasses: Record<string, string> = {
  ...
  highlight: 'shadow-lg border border-emerald-100 hover:shadow-emerald-200/50 hover:border-emerald-200',
...
const Card: React.FC<CardProps> = ({
  ...
  const classes = [
    ...
    glow ? 'hover:ring-2 hover:ring-emerald-500/30 hover:ring-offset-2' : '',
    border ? 'border border-gray-100' : '',
    'focus-within:outline-none focus-within:ring-2 focus-within:ring-emerald-500/40',
    className
  ].filter(Boolean).join(' ');
