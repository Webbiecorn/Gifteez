...
const HomePage: React.FC<HomePageProps> = ({ navigateTo }) => {
  ...
  return (
    <div className="space-y-20 pb-20">
            ...
            <div className="relative flex justify-center lg:justify-end">
              <animated.div
                ...
                style={{
                  ...
                  transform: springTo(
                    [heroImageSpring.y, heroImageSpring.scale],
                    (y, scale) => `translate3d(0, ${y}px, 0) scale(${scale})`
                  ),
                  willChange: 'transform, opacity',
                }}
      ...
      <section
        className="relative overflow-hidden bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 py-24 opacity-0 animate-fade-in-up"
            ...
            <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
              ...
              <div>
                ...
                <p className="typo-body mt-6 text-gray-700">
                  Doe onze interactieve Cadeau Quiz en ontdek in slechts een paar minuten welk type
                  cadeaus perfect passen bij jouw vriend(in), partner of familielid. Geen eindeloos
                  scrollen meer – direct de juiste richting!
                </p>
                ...
                <ul className="mt-8 space-y-4">
                  <li className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">
                        Binnen 2 minuten weet je welke cadeaus passen
                      </p>
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">
                        Aanbevelingen op maat van de ontvanger
                      </p>
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
