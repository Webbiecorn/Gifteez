...
export const CakeIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg className={className} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    ...
    <path d="M4 16c-1.1 0-2-.9-2-2v-4c0-1.1.9-2 2-2" />
    <path d="M20 16c1.1 0 2-.9 2-2v-4c0-1.1-.9-2-2-2" />
    <path d="M16 11V7a4 4 0 0 0-8 0v4" />
    <path d="M12 21v-3" />
    <path d="M12 8c.8 0 1.5-.9 1.5-2s-.7-2-1.5-2-1.5.9-1.5 2 .7 2 1.5 2z" />
  </svg>
);

export const SnowflakeIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        <line x1="12" y1="2" x2="12" y2="22" /><line x1="17" y1="5" x2="7" y2="15" /><line x1="7" y1="9" x2="17" y2="19" /><line x1="17" y1="19" x2="7" y2="9" /><line x1="7" y1="15" x2="17" y2="5" />
    </svg>
);
...
export const PinterestIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        <path d="M12 4a8 8 0 0 0-8 8c0 3.5 2 6.5 5 7.5-.5-2 .5-4 1-5.5C9.5 13.5 9 12.5 9 11c0-2 1.5-4 4-4s4 2 4 4c0 1.5-.5 2.5-1 3.5.5 1.5 1 3.5 1 5.5 3-1 5-4 5-7.5a8 8 0 0 0-8-8z" />
    </svg>
);
...
export const UserCircleIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        <path d="M5.52 19c.64-2.2 1.84-4 3.22-5.26A7.79 7.79 0 0 1 12 12a7.79 7.79 0 0 1 3.26 1.74c1.38 1.26 2.58 3.06 3.22 5.26" />
        <circle cx="12" cy="12" r="10" />
    </svg>
);
...
export const BookmarkFilledIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg className={className} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
    <path d="M19 21l-7-5-7 5V5a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2z" />
  </svg>
);
