...
const InternalLinkCTA: React.FC<InternalLinkCTAProps> = ({
  ...
  const variantClasses = {
    primary: 'bg-gradient-to-r from-primary/10 to-accent/10 border-primary/20 hover:border-primary/40',
    secondary: 'bg-gradient-to-r from-secondary/30 to-secondary/50 border-secondary/30 hover:border-secondary/50',
    accent: 'bg-gradient-to-r from-accent/10 to-purple-500/10 border-accent/20 hover:border-accent/40'
  };
