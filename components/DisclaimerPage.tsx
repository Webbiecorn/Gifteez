...
const DisclaimerPage: React.FC<DisclaimerPageProps> = ({ navigateTo }) => {
  useEffect(() => {
    ...
    metaDesc.setAttribute(
      'content',
      'Disclaimer en juridische voorwaarden van Gifteez.nl - Lees onze algemene voorwaarden en aansprakelijkheid.'
    )
      ...
      <section className="relative bg-gradient-to-r from-primary via-accent to-accent-hover text-white overflow-hidden">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-28 relative z-10">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <h1 className="typo-h1 mb-6 leading-tight text-white">Disclaimer</h1>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-white rounded-3xl shadow-xl p-8 md:p-12 border border-gray-100">
            <div className="prose prose-lg lg:prose-xl max-w-none text-gray-700">
              ...
              <p>
                Gifteez.nl is een website die cadeautips en cadeau-ideeën aanbiedt met behulp van
                kunstmatige intelligentie. Wij streven ernaar accurate en nuttige informatie te
                verstrekken, maar kunnen geen garantie geven voor de volledigheid of juistheid van
                de informatie.
              </p>

              <h2>2. Gebruik van de Website</h2>
              <p>
                Door gebruik te maken van Gifteez.nl gaat u akkoord met deze disclaimer. Het gebruik
                van onze website is geheel op eigen risico. Wij zijn niet verantwoordelijk voor
                eventuele schade die voortvloeit uit het gebruik van onze website of de informatie
                die daarop wordt verstrekt.
              </p>

              <h2>3. Productinformatie en Prijzen</h2>
              <p>
                Gifteez.nl fungeert als Amazon-partner en partner van andere webshops.
                Productinformatie, prijzen en beschikbaarheid kunnen zonder voorafgaande
                kennisgeving veranderen. Wij raden u aan altijd de actuele informatie te controleren
                op de website van de betreffende verkoper voordat u een aankoop doet.
              </p>

              <h2>4. Affiliate Links</h2>
              <p>
                Sommige links op onze website zijn affiliate links. Wanneer u via deze links een
                aankoop doet, ontvangen wij mogelijk een commissie. Dit heeft geen invloed op de
                prijs die u betaalt, maar helpt ons om de website gratis aan te bieden en te
                verbeteren.
              </p>

              <h2>5. AI-Generated Content</h2>
              <p>
                De cadeau-aanbevelingen op Gifteez.nl worden gegenereerd met behulp van kunstmatige
                intelligentie. Hoewel wij ons best doen om accurate en relevante suggesties te
                geven, zijn deze aanbevelingen niet gegarandeerd en dienen uitsluitend als
                inspiratie.
              </p>
              ...
              <p>
                Alle content op Gifteez.nl, inclusief teksten, afbeeldingen, logo's en software, is
                beschermd door intellectuele eigendomsrechten. Het is niet toegestaan om deze
                content te kopiëren, verspreiden of gebruiken zonder voorafgaande schriftelijke
                toestemming.
              </p>
              ...
              <div className="mt-12 p-6 bg-secondary rounded-2xl border border-muted-rose">
                ...
                <p className="text-accent">
                  Deze disclaimer is bedoeld om onze rechten en plichten duidelijk te maken. Het
                  gebruik van Gifteez.nl blijft volledig op eigen risico. Bij twijfel over
                  juridische zaken raden wij u aan professioneel advies in te winnen.
                </p>
              </div>
            </div>
          </div>
