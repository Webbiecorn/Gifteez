...
import { NavigateTo, ShowToast, GiftProfile } from '../types';
    ...
    <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center mb-8 border-b pb-4">
            <div>
                ...
                <p className="mt-2 text-lg text-gray-600">Welkom terug, <span className="font-bold">{auth.currentUser.name}</span>!</p>
            </div>
        ...
        <section className="mb-12">
            ...
            <p className="text-gray-600 mb-6">Sla profielen op voor de mensen aan wie je vaak cadeaus geeft. Dit maakt het zoeken met de GiftFinder nog sneller!</p>
