              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-sm text-gray-600 mt-1">
                    Sneltoetsen om efficiënter te werken
                  </p>
                </div>
                <button
                  onClick={() => setShowShortcuts(false)}
              ...
              <div className="space-y-4">
                ...
                <div className="bg-purple-50 rounded-lg p-4 border border-purple-200">
                  ...
                  <ul className="text-sm text-gray-600 space-y-1">
                    ...
                    <li>• Op Mac gebruik je <kbd className="px-1 py-0.5 bg-white border border-gray-300 rounded text-xs">⌘</kbd>, op Windows/Linux <kbd className="px-1 py-0.5 bg-white border border-gray-300 rounded text-xs">Ctrl</kbd></li>
                    <li>• Hover over knoppen voor tooltips met shortcuts</li>
                    <li>• Druk op <kbd className="px-1 py-0.5 bg-white border border-gray-300 rounded text-xs">?</kbd> om deze lijst altijd te tonen</li>
                  </ul>
                </div>
              </div>
            </div>
