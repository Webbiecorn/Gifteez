...
const HomePage: React.FC<HomePageProps> = ({ navigateTo }) => {
  ...
  const { variant: heroImage, trackConversion: trackHeroImageClick } = useABTest('hero_image_style', {
    A: { 
  ...
  return (
    <div className="home-page">
      ...
      <section className="hero-section">
        <div className="hero-content">
          ...
          <p className="hero-subtitle">
            Binnen 30 seconden het perfecte cadeau met AI
          </p>
      ...
      {newsletterPosition !== 'C' && (
        <section 
          className={`newsletter-section newsletter-section--${newsletterPosition}`}
        >
