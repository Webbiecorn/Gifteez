  ...
  private loadConfig(): EnvironmentConfig {
    return {
      ...
      features: {
        ...
        affiliateDisclosure: this.parseBoolean(
          import.meta.env.VITE_FEATURE_AFFILIATE_DISCLOSURE,
          true
        ),
        ...
        productRecommendations: this.parseBoolean(
          import.meta.env.VITE_FEATURE_PRODUCT_RECOMMENDATIONS,
          true
        ),
      },
