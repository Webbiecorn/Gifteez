...
<link
  rel="preload"
  as="image"
  href="/images/giftfinder-hero.png"
  imagesrcset="/images/giftfinder-hero.webp 1920w, /images/giftfinder-hero.png 1920w"
  imagesizes="100vw"
/>
```
...
- **Bronbestand bevat PNG-data maar heeft `.jpg`-extensie**: ~~`about-story.jpg`, `collection-mailbox.jpg`, `collection-travel.jpg`, `planner.jpg`, `trending-experience.jpg`~~ ✅ opgelost → gebruik nu `.png`
...
2. Hernoem PNG-bestanden met `.jpg`-extensie naar `.png` (klaar voor alle huidige assets) of encodeer ze als echte JPG indien gewenst. Het script ondersteunt gemixte signatures, maar logt nu een waarschuwing als extensie ≠ inhoud.
