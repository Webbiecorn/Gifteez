      ...
      <div className="max-w-2xl w-full">
        ...
        >
          <div className="mt-8 grid grid-cols-1 md:grid-cols-2 gap-4">
            <Button variant="primary" onClick={() => navigateTo('giftFinder')} fullWidth>
              🎁 Start GiftFinder
            </Button>
            <Button variant="secondary" onClick={() => navigateTo('deals')} fullWidth>
              🔥 Bekijk Deals
            </Button>
            <Button variant="secondary" onClick={() => navigateTo('categories')} fullWidth>
              📂 Categorieën
            </Button>
            <Button variant="secondary" onClick={() => navigateTo('blog')} fullWidth>
              📝 Blog
            </Button>
          </div>
      ...
      <div className="max-w-2xl w-full">
        ...
        >
          <div className="mt-8 flex flex-col gap-3">
            <Button variant="secondary" onClick={() => navigateTo('home')} fullWidth>
              🏠 Terug naar Home
            </Button>
            <Button variant="ghost" onClick={() => navigateTo('contact')} fullWidth>
              📧 Meld dit probleem
            </Button>
          </div>
