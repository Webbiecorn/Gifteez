...
export const SEOConfigs = {
  home: {
    ...
    description:
      'Ontdek het perfecte cadeau met onze AI-gedreven gift finder. Persoonlijke aanbevelingen voor elke gelegenheid en budget. Gratis en snel!',
    keywords:
      'cadeau finder, AI gift finder, cadeaus, geschenken, persoonlijke aanbevelingen, verjaardag, kerst',
    canonical: 'https://gifteez.nl/',
  },
  giftFinder: {
    title: 'AI Gift Finder - Vind het Perfecte Cadeau | Gifteez.nl',
    description:
      'Gebruik onze slimme AI gift finder om in seconden het perfecte cadeau te vinden. Voer je voorkeuren in en ontvang gepersonaliseerde suggesties.',
    keywords:
      'AI gift finder, cadeau zoeken, persoonlijke cadeaus, gift suggestions, cadeau aanbevelingen',
    canonical: 'https://gifteez.nl/giftfinder',
  },
  blog: {
    title: 'Cadeau Blog - Inspiratie & Gidsen | Gifteez.nl',
    description:
      'Ontdek de beste cadeau-ideeën, trends en gidsen in onze blog. Van verjaardagscadeaus tot seizoensgebonden geschenken - alle inspiratie op één plek.',
  ...
  about: {
    ...
    description:
      'Leer meer over Gifteez.nl en ons team. Ontdek hoe we AI gebruiken om het perfecte cadeau voor jou te vinden en waarom we begonnen zijn.',
  ...
  contact: {
    ...
    description:
      'Heb je vragen of feedback? Neem contact met ons op! We helpen je graag verder met al je cadeau-gerelateerde vragen.',
  ...
  quiz: {
    ...
    description:
      'Doe onze leuke cadeau quiz en ontdek welke cadeaus het beste bij jou passen. Krijg gepersonaliseerde aanbevelingen op basis van je voorkeuren.',
  ...
  deals: {
    ...
    description:
      'Ontdek de beste cadeau deals en aanbiedingen van vandaag. Bespaar geld op geweldige geschenken met onze handmatig geselecteerde kortingen.',
