...
export const quizQuestions: QuizQuestion[] = [
  {
    ...
    answers: [
      {
        text: 'Lekker thuis op de bank met een film of boek.',
        value: 'homebody',
        resultKey: 'homebody',
      },
      {
        text: 'Een nieuwe stad ontdekken of een wandeling in de natuur.',
        value: 'adventurer',
        resultKey: 'adventurer',
      },
      {
        text: 'Uitgebreid koken en vrienden uitnodigen voor een diner.',
        value: 'foodie',
        resultKey: 'foodie',
      },
      {
        text: 'Een museum bezoeken of naar een concert gaan.',
        value: 'creative',
        resultKey: 'creative',
      },
    ],
  },
  {
    ...
    answers: [
      {
        text: 'Iets praktisch dat het dagelijks leven makkelijker maakt.',
        value: 'homebody',
        resultKey: 'homebody',
      },
      {
        text: 'Een onvergetelijke ervaring of een avontuur.',
        value: 'adventurer',
        resultKey: 'adventurer',
      },
      {
        text: 'Een luxe delicatesse of een speciaal kookgadget.',
        value: 'foodie',
        resultKey: 'foodie',
      },
      {
        text: 'Iets unieks en handgemaakts met een persoonlijk verhaal.',
        value: 'creative',
        resultKey: 'creative',
      },
    ],
  },
  {
    ...
    answers: [
      {
        text: 'Een comfortabel huisje waar ze helemaal tot rust kunnen komen.',
        value: 'homebody',
        resultKey: 'homebody',
      },
      {
        text: 'Een backpack-reis door een onbekend land.',
        value: 'adventurer',
        resultKey: 'adventurer',
      },
      {
        text: 'Een culinaire tour door Italië of Frankrijk.',
        value: 'foodie',
        resultKey: 'foodie',
      },
      {
        text: 'Een citytrip vol kunst, cultuur en architectuur.',
        value: 'creative',
        resultKey: 'creative',
      },
    ],
...
const RAW_QUIZ_RESULTS: Record<string, QuizResult> = {
  homebody: {
    ...
    description:
      'Deze persoon hecht waarde aan comfort, rust en gezelligheid. Een perfect cadeau voor hen maakt hun huis nog aangenamer of helpt ze te ontspannen. Denk aan zachte dekens, sfeerverlichting, een goed boek of een luxe set voor een spa-dag thuis.',
  ...
  adventurer: {
    ...
    description:
      'Stilzitten is niks voor deze persoon! Ze houden van nieuwe ervaringen, reizen en de buitenlucht. Een geweldig cadeau is iets dat hun volgende avontuur ondersteunt, zoals een goede rugzak, een portable speaker, een outdoor-gadget of een reisgids.',
    ...
    occasionHighlights: {
      ...
      housewarming:
        'Voor een housewarming kun je denken aan praktische travel gear voor het nieuwe hoofdstuk.',
  ...
  foodie: {
    ...
    description:
      'Het leven van deze persoon draait om lekker eten en drinken. Ze zijn vaak in de keuken te vinden of proberen het nieuwste restaurant in de stad. Maak ze blij met een speciaal kookboek, een luxe ingrediënt, een mooie pannenset, of een workshop van een topchef.',
  ...
  creative: {
    ...
    description:
      'Deze persoon heeft een passie voor kunst, muziek, design en zelfexpressie. Ze waarderen unieke, handgemaakte en esthetisch mooie dingen. Denk aan een prachtig notitieboek, een set professionele potloden, een museumkaart, of een design-object voor in huis.',
