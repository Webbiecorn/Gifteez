...
Zet sleutels in `.env` met VITE\_ prefix (zie `.env.example`).
...
2. Configure env vars
   ...
   - Fill in VITE*GEMINI_API_KEY and optional Firebase VITE_FIREBASE*\*
...
- Vite env variables must be prefixed with VITE\_.
