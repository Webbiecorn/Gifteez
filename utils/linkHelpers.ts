 ...
 * </a>
 */
export function getAffiliateLinkProps(url: string, label?: string): AffiliateLinkProps {
...
export function getExternalLinkProps(url: string, label?: string): ExternalLinkProps {
